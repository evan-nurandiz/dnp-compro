...
<section>
    ...
    <div class="max-w-screen-lg mx-auto">
        <div class="mb-24 px-4 md:px-0">
            <p class="text-[#fafafa] font-extralight text-[30px] lg:text-[38px] mb-8">A Multidisciplinary Creative <br class="hidden md:block"> Consulting Stop Agency <br> dedicated to make your brand</p>
        ...
        <div class="mb-48 px-4 lg:px-0">
            <div class="grid grid-cols-1 gap-8 md:grid-cols-2 justify-between md:gap-18 lg:gap-24 md:mb-24">
