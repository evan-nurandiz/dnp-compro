...
<div class="max-w-screen-lg mx-auto py-[160px]">
    <div class="bg-white p-4">
        ...
        <div class="border-[1px] border-gray-100 md:px-24 md:py-16">
                ...
                <div class="flex gap-2 items-center">
                    ...
                    <div class="flex items-center gap-1">
                        <div class="flex items-center">
                            <p class="text-[#2f2e2e] text-[12px]">Devin GodFrey</p>
                            <img src="{{url('/icon/crown-icon.svg')}}" alt="">
                        </div>
                        <p class="text-[#2f2e2e] text-[12px]">• {{ \Carbon\Carbon::parse($blog->created_at)->format('M d, Y')}} • {{$blog->read_time}}</p>
                    </div>
                </div>
