...
<div class="relative overflow-x-auto h-screen p-4">
    <div class="bg-gray-50 rounded-b-lg rounded-r-lg">
        <form class="p-4" method="post" action="{{route('admin-cms-project-store')}}" enctype="multipart/form-data">
            @csrf
            {{ method_field('POST') }}
            ...
            <div class="mb-4">
                ...
                " 
                placeholder="Title" required name="project_title" value="">
                @error('project_title')
                    <div class="alert alert-danger">{{ $message }}</div>
                @enderror
            </div> 
            <div class="mb-4">
                ...
                focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 
                " 
                placeholder="Category" required name="project_category" value="">
            ...
            <label for="project_content_image_input" class="mb-6 w-[70%] h-[501px] flex items-center bg-black mx-auto" id="project_content_image_preview_container">
                <img src="" alt="" id="project_content_image_preview" class="w-100 mx-auto max-h-[480px]">
            </label>
            <div class="mb-8">
                <input class="block w-full text-sm text-gray-900  border border-gray-300 rounded-lg cursor-pointer bg-gray-50 
                hidden" 
            ...
            <textarea id="editor" name="project_body"></textarea>
            @error('project_body')
                <div class="alert alert-danger">{{ $message }}</div>
            @enderror
